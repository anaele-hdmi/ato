...
import { PhotoTrees } from './photo-trees';
...
export class Vegetation {
  ...
  readonly photo: PhotoTrees;
  private crowns: THREE.Mesh;
  private trunks: THREE.Mesh;
  ...
  update(year: number, cover: number, projScale: number): void {
    ...
    // photographs replace the drawn crowns once they have loaded
    const photo = this.photo.mesh.visible;
    this.crowns.visible = !photo;
    this.trunks.visible = !photo;
